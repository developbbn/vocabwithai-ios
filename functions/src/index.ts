 ...
 * Gemini 503/429 에러 시 자동 재시도 (최대 3회, exponential backoff).
 */
...
// Secret Manager에 저장된 Gemini API 키
const GEMINI_API_KEY = defineSecret("GEMINI_API_KEY");

// Gemini 모델 (iOS와 동일하게 gemini-2.5-flash)
...
// ============================================================
// Helper: 503/429 에러 시 자동 재시도 (exponential backoff)
// ============================================================
...
// ============================================================
// 기본 프롬프트 (iOS의 GeminiService.defaultWordPrompt 와 동일)
// ============================================================
...
// ============================================================
// 기본 프롬프트 (iOS의 GeminiService.defaultPhrasePrompt 와 동일)
// ============================================================
